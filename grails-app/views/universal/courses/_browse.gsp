...
<div class="mb-6 flex gap-2">
    <input hx-get="/universal/showView"
           hx-vals='{"template": "courses/browse", "data[courses]": "search:Course:longTitle,shortTitle,shortDescription:q", "data[user]": "currentUser"}'
...
<g:else>
    <g:render template="/universal/components/emptyState" model="[message: 'No courses available yet']"/>
</g:else>
